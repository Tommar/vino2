...
class ModBtSmartsearchHelper
{
	public static function fetchHead($params) {
		...
		// load css
		if(file_exists(JPATH_BASE.'/templates/'.$template.'/html/mod_bt_smartsearch/css/form.css'))
		{
			$document->addStyleSheet(  JURI::root().'templates/'.$template.'/html/mod_bt_smartsearch/css/form.css');
		}
		else{
			$document->addStyleSheet(JURI::root().'modules/mod_bt_smartsearch/tmpl/css/form.css');
		}
		
		if(file_exists(JPATH_BASE.'/templates/'.$template.'/html/mod_bt_smartsearch/css/chosen.css'))
		{
			$document->addStyleSheet(  JURI::root().'templates/'.$template.'/html/mod_bt_smartsearch/css/chosen.css');
		}
		else{
			$document->addStyleSheet(JURI::root().'modules/mod_bt_smartsearch/tmpl/css/form.css');
		}
