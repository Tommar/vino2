	...
	<div class="slider-holder prel">
		...
		<?php foreach ( $featured as $row ){ ?>
			<li class="featured-item">
				...
				<div class="featured-item-infor">
				
					<div class="list_blog_date">
						<div class="date_month"><?php echo $this->formatDate( 'M' , $row->created ); ?></div>
						<div class="date_year"><?php echo $this->formatDate( 'Y' , $row->created ); ?></div>
					</div>
					
					
					<?php if ( $system->config->get('layout_avatar') ) : ?>
							<a href="<?php echo $row->author->getProfileLink(); ?>" class="feature-avatar"><img src="<?php echo $row->author->getAvatar(); ?>" width="35" height="35" class="avatar" /></a>
							<?php endif; ?>
					...
					<div class="featured-author">
							...
							<div class="feature-infor1">	
								<div class="showcase-author-infor">
									<?php echo JText::_('BT_FASHION_COM_EASYBLOG_WRITENT_BY'); ?> <a href="<?php echo $row->author->getProfileLink(); ?>"><?php echo $row->author->getName(); ?></a>
								</div>
			...
			<div class="featured-image-wapper">
				<div class="featured-image-wapper-2">
				<?php if( $row->getImage() ){ ?>
					<!-- Blog Image -->
