...
<div id="comment-form" class="blog-section easy-blog-comment clearfix">
	<a name="commentform" id="commentform"></a>

	<h3 class="section-title" id="comment-form-title"><span><?php echo JText::_('COM_EASYBLOG_LEAVE_YOUR_COMMENT');?></span></h3>
		...
		<span class="comment-date"><?php echo EasyBlogDateHelper::toFormat( EasyBlogDateHelper::dateWithOffSet() , $config->get('layout_dateformat', '%A, %d %B %Y')); ?></span>
			...
			<div class="comment-body prel">
                ...
                <div class="bg-form-row">
                  ...
                  <div class="form-row username-field">
                    <div class="form-row-inner">
						<label class="label" for="esusername"><?php echo JText::_('COM_EASYBLOG_USERNAME'); ?> (<?php echo JText::_('COM_EASYBLOG_REQUIRED_FOR_REGISTRATIONS'); ?>)</label>
                      <input class="inputbox" type="text" id="esusername" name="esusername" onblur="if (this.value == '') {this.value = '<?php echo JText::_('COM_EASYBLOG_USERNAME'); ?>';}" onfocus="if (this.value == '<?php echo JText::_('COM_EASYBLOG_USERNAME'); ?>') {this.value = '';}" value="<?php echo JText::_('COM_EASYBLOG_USERNAME'); ?>">
                    </div>
                  </div>
                  <?php endif; ?>
                  ...
                  <div class="form-row name-field">
                    <div class="form-row-inner">
                      <label class="label" for="esname"><?php echo JText::_('COM_EASYBLOG_NAME'); ?></label>
                      <input class="inputbox" type="text" id="esname" name="esname" onblur="if (this.value == '') {this.value = '<?php echo JText::_('COM_EASYBLOG_NAME' , true ); ?>';}" onfocus="if (this.value == '<?php echo JText::_('COM_EASYBLOG_NAME' , true); ?>') {this.value = '';}" value="<?php echo JText::_('COM_EASYBLOG_NAME' , true ); ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-row email-field">
                    <div class="form-row-inner">
                        ...
                        <label class="label" for="esemail"><?php echo JText::_('COM_EASYBLOG_EMAIL'); ?></label>
                        <input class="inputbox" type="text" id="esemail" name="esemail" onblur="if (this.value == '') {this.value = '<?php echo JText::_('COM_EASYBLOG_EMAIL'); ?>';}" onfocus="if (this.value == '<?php echo JText::_('COM_EASYBLOG_EMAIL'); ?>') {this.value = '';}" value="<?php echo JText::_('COM_EASYBLOG_EMAIL'); ?>">
                    </div>
                    </div>
                  <?php } ?>
                  ...
                  <div class="form-row website-field">
                    <div class="form-row-inner">
                        <label class="label" for="url"><?php echo JText::_('COM_EASYBLOG_WEBSITE'); ?></label>
                        <input class="inputbox" type="text" id="url" name="url" onblur="if (this.value == '') {this.value = '<?php echo JText::_('COM_EASYBLOG_WEBSITE'); ?>';}" onfocus="if (this.value == '<?php echo JText::_('COM_EASYBLOG_WEBSITE'); ?>') {this.value = '';}" value="<?php echo JText::_('COM_EASYBLOG_WEBSITE'); ?>">
                    </div>
                  </div>
                  <?php } ?>
		  ...
		  <div class="form-row comment-editor prm">
