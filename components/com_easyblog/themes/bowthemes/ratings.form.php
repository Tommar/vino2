...
<form id="<?php echo $elementId; ?>-form" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
	...
	<div id="<?php echo $elementId; ?>-command" class="blog-rating-text">
		<?php if( !empty( $command ) ): ?>
			<?php echo JText::_( 'BT_FASHION_COM_EASYBLOG_RATING' );?>
		<?php endif; ?>
	</div>
	<?php endif; ?>
	...
	<div id="<?php echo $elementId; ?>" class="star-location prel<?php if( $voted ){ echo " voted"; } ?>">
		<input type="radio" name="newrate" value="1" itemprop="worstRating" title="Very poor"<?php echo ($rating == 1 ) ? ' checked="checked"' : '';?> class="odd" />
		...
		<input type="radio" name="newrate" value="10" itemprop="bestRating" title="Perfect"<?php echo ($rating == 10 ) ? ' checked="checked"' : '';?> />
