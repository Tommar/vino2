...
<ul class="pagination-list">
	...
	<?php } else { ?>
		<li class="disabled">
			<span><?php echo JText::_( 'COM_EASYBLOG_PAGINATION_PREVIOUS' );?></span>
		</li>
		<?php } ?>
	...
	<?php foreach( $data->pages as $page ){ ?>
		...
		<?php 	} else { ?>
		<li class="active"><a><?php echo $page->text;?></a></li>
		<?php 	} ?>
	<?php } ?>
	...
	<li class="disabled">
			<span><?php echo JText::_( 'COM_EASYBLOG_PAGINATION_NEXT' );?></span>
		</li>
		<?php } ?>
</ul>
