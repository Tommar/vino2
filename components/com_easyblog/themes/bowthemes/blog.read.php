...
<div id="ezblog-body" itemscope itemtype="http://schema.org/Blog">
	...
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read clearfix">
		...
		<div class="blog-header">
			<div class="list_blog_date">
				<?php echo $this->fetch( 'blog.meta.read_detail_date.php' , array( 'row' => $blog , 'postedText' => JText::_( 'COM_EASYBLOG_POSTED' ) ) ); ?>
			</div>
			<div class="">
				...
				<div class="list_blog_item_infor">
					<div class="item_infor_1">
						<?php echo $this->fetch( 'blog.meta.read_detail.php' , array( 'row' => $blog , 'postedText' => JText::_( 'COM_EASYBLOG_POSTED' ) ) ); ?>
					</div>
					<div class="item_infor_2">
						<ul class="reset-ul float-li">
							<?php if( $this->getParam( 'show_hits' , true ) ){ ?>
							<li class="blog-hit">
								<?php echo JText::sprintf( 'BT_FASHION_COM_EASYBLOG_HITS_TOTAL' , $blog->hits ); ?>
							</li>
							<?php } ?>
							...
							<?php if( $system->config->get( 'main_ratings' ) ) { ?>
								<!-- Blog ratings -->
								<?php echo $this->fetch( 'blog.rating_details.php' , array( 'row' => $blog ) ); ?>
							<?php } ?>
		...
		<div class="blog_read_title">
			...
			<h1 id="title-<?php echo $blog->id; ?>" class="blog-title<?php echo ($isFeatured) ? ' featured-item' : '';?> rip" itemprop="name"><?php echo $blog->title; ?>
	...
	<div class="author_related_link">
		...
		<div class="author_link">
			<div class="author_link_inner">
				<?php  echo $this->fetch( 'author.info_recentpost.php', array( 'authorRecentPosts' => $authorRecentPosts) ); ?>
			</div>
		</div>
	<div style="clear:both;"></div>
	</div>
