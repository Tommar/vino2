...
<?php
  ...
  if ($this->countModules("$sidebar1 and $sidebar2")) {
    $layout = 'two_sidebars';
	$classT3Content = "t3-content-inner";
  } elseif ($this->countModules($sidebar1)) {
    $layout = 'one_sidebar1';
	$classT3Content = "t3-content-sidebar1";
  } elseif ($this->countModules($sidebar2)) {
    $layout = 'one_sidebar2';
	$classT3Content = "t3-content-sidebar2";
  } else {
    $layout = 'no_sidebar';
	$classT3Content = "t3-content-full";
  }
...
<div id="t3-mainbody" class="container t3-mainbody">
  <div class="row">
    ...
    <div id="t3-content" class="t3-content <?php echo $this->getClass($layout, $col) ?>" <?php echo $this->getData ($layout, $col++) ?>>
		<div class="<?php echo $classT3Content;?>">
