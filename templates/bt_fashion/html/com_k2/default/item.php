...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader">
		...
		<div class="list_blog_date">
			<div class="date_month"><?php echo JHTML::_('date', $this->item->created , 'M'); ?></div>
			<div class="date_year"><?php echo JHTML::_('date', $this->item->created , 'Y'); ?></div>
		</div>
		<?php endif; ?>
			...
			<div class="content_item_infor">
				...
				<?php if($this->item->params->get('itemRating')): ?>
					...
					<div class="itemRatingBlock">
						<span><?php echo JText::_('BT_FASHION_K2_RATE_THIS_ITEM'); ?></span>
				...
				<?php if($this->item->params->get('itemCommentsAnchor') && $this->item->params->get('itemComments') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) ): ?>
					...
					<div class="item_comment_link">
						...
						<?php else: ?>
							...
							<?php else: ?>
							<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
								<?php echo JText::_('BT_FASHION_K2_BE_THE_FIRST_TO_COMMENT'); ?>
							</a>
							<?php endif; ?>
						<?php endif; ?>
					</div>
...
-->
  ...
  <?php if(	$this->item->params->get('itemCategory') || $this->item->params->get('itemTags') || $this->item->params->get('itemAttachments') ||
			$this->item->params->get('itemHits') || ($this->item->params->get('itemDateModified') && intval($this->item->modified)!=0)): ?>
  <div class="itemLinks">
  ...
  <div class="itemAuthorBlock">
	...
	<div class="userItemAdditionalInfo">
      <?php if($this->item->params->get('itemAuthorURL') && !empty($this->item->author->profile->url)): ?>
      <div class="itemAuthorUrl"><?php echo JText::_('K2_WEBSITE'); ?> <a rel="me" href="<?php echo $this->item->author->profile->url; ?>" target="_blank"><?php echo str_replace('http://','',$this->item->author->profile->url); ?></a></div>
      <?php endif; ?>

      <?php if($this->item->params->get('itemAuthorEmail')): ?>
      <div class="itemAuthorEmail"><?php echo JText::_('K2_EMAIL'); ?> <?php echo JHTML::_('Email.cloak', $this->item->author->email); ?></div>
      <?php endif; ?>
	</div>
...
<div class="author_related">
  <?php if($this->item->params->get('itemAuthorLatest') && empty($this->item->created_by_alias) && isset($this->authorLatestItems)): ?>
	<div class="author_related_inner">
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
	    	...
	    	<span class="commentLink">
				...
				<img class="item_comment_avt" src="<?php echo $comment->userImage; ?>" alt="<?php echo JFilterOutput::cleanText($comment->userName); ?>" width="<?php echo $this->item->params->get('commenterImgWidth'); ?>" />
				<?php endif; ?>
				...
				<span class="commentDate">
					<?php echo JHTML::_('date', $comment->commentDate, 'd.m.Y'); ?>
				</span>
