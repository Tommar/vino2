	...
	<div class="userBlock">
		...
		<div class="category_head_infor">	
			...
			<div class="userAdditionalInfo">
				...
				<div class="userURL">
					<?php echo JText::_('BT_FASHION_K2_WEBSITE_URL'); ?><a href="<?php echo $this->user->profile->url; ?>" target="_blank" rel="me"><?php echo $this->user->profile->url; ?></a>
				</div>
				<?php endif; ?>
		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
			...
			<div class="userItemHeader">			
				...
				<div class="list_blog_date">
					<div class="date_month"><?php echo JHTML::_('date', $item->created , 'M'); ?></div>
					<div class="date_year"><?php echo JHTML::_('date', $item->created , 'Y'); ?></div>
				</div>
				<?php endif; ?>
		  ...
		  <div class="userItemLinks">
			  ...
			  <div class="userItemTagsBlock">
				  <span><?php echo JText::_('BT_FASHION_K2_TAGGED_UNDER'); ?></span>
