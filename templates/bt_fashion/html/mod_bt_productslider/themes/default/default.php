		...
		<div  style="<?php echo $add_style;?>">
			...
			<?php echo '<li>'?>
				...
				<div class="bt-row " style="width: <?php echo $itemWidth?>%;">
					<div class="bt-row1"><div class="bt-inner">
						...
						<a class="bt-title" target="<?php echo $openTarget; ?>"
								...
								href="<?php echo $row->link;?>"> <?php echo $row->name_cut; ?> </a>
						<?php endif; ?>
						<?php if($showPrice):?>
						<div class="bt-prices">
						...
						<div class="bt-extra">
							...
							<span class="bt-review-count"><?php echo JText::sprintf('BT_FASHION_REVIEW_COUNT', $row->reviews_count ? $row->reviews_count : 0); ?></span>
							<?php endif; ?>
