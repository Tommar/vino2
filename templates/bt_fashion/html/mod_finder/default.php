...
$output = '<input type="text" name="q" id="mod-finder-searchword" class="input inputbox" size="' . $params->get('field_size', 20) . '" placeholder="' . htmlspecialchars(JFactory::getApplication()->input->get('q', '', 'string')) . '" />';
$button = '';
$label = '';
