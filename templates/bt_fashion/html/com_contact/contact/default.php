...
<?php endif; ?>
	...
	$modules = JModuleHelper::getModules('map_contact_page');
				$attribs['style'] = 'T3Xhtml';
		?>
		<?php if ($modules): ?>
			<div id="map_contact" class="map_contact">
	...
	<div class="contact-form-info">	
		<?php if ($this->params->get('presentation_style')=='plain'):?>
			<?php  echo '<h3 class="label_contact_form"><span>'. JText::_('BT_FASHION_COM_CONTACT_EMAIL_FORM').'</span></h3>';  ?>
		<?php endif; ?>
