...
<?php if ($this->allow_review){?>
    ...
    <?php foreach($this->reviews as $curr){?>
        ...
        <div class="rating">
			<span class="review_user"><?php print $curr->user_name?></span>, <span class='review_time'><?php print formatdate($curr->time);?></span>
			<?php if ($curr->mark) {?>
				<div class="review_mark"><span><?php echo JText::_('BT_FASHION_K2_RATE_THIS_ITEM')?></span><?php print showMarkStar($curr->mark);?></div>
			<?php } ?> 
		</div>
