...
<table class="jshop cart">
  <tr>
    ...
    <th width="13%" style="text-align:left; padding-left:20px;" >
  ...
  <tr class="jshop_prod_cart <?php if ($i%2==0) print "even"; else print "odd"?>">
    ...
    <td>
        <div class="basic_price"><?php print formatprice($prod['price'])?></div>
    ...
    <td>
        <div class="basic_price"><?php print formatprice($prod['price']*$prod['quantity']); ?></div>
...
<table class="jshop" style="margin-top:10px">
  <tr id = "checkout">
    ...
    <?php }?>
	<a class="back-shop" href = "<?php print $this->href_shop ?>"></a>
    </td>
  </tr>
</table>
</form>
...
<div class="discount">  
      <span><?php print _JSHOP_RABATT ?></span>
