...
<div class="product productitem_<?php print $product->product_id?>">
	...
	<div class="review_mark">
		...
		<span class="count_commentar">
			<?php echo JText::sprintf('BT_FASHION_REVIEW_COUNT', $product->reviews_count);?>
		</span>
	...
	<div style="clear:both;"></div>
	 ...
	 <div class="buttons">
            ...
            <a class="button_detail button" href="<?php print $product->product_link?>"><?php print _JSHOP_DETAIL?></a>
			<?php if ($product->buy_link){?>
            <a class="button_buy button cart" href="<?php print $product->buy_link?>"><?php echo JText::_('BT_FASHION_ADDTOCAT');?></a>
            <?php }?>
