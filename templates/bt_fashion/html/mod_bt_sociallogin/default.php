...
<div id="btl">
	...
	<div class="btl-panel">
		...
		<?php else : ?>
			<!-- Login button -->
			 <span id="btl-panel-login" class="<?php echo $effect;?>"></span> 
			...
			?>
			<span id="btl-panel-registration" class="<?php echo $effect;?>"></span>
			<?php }
			} ?>
	...
	<div id="btl-content">
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<div id="social-connect">
				...
				<ul>
					<?php /*if($enable_fb):?><li id="bt-facebook"><a href="JavaScript:newPopup('<?php echo $dialog_urlFB?>','<?php echo JText::sprintf ( 'MOD_BT_LOGIN_CONNECT_TITLE', 'Facebook'); ?>',600,400);"><img src="<?php echo JURI::root(); ?>/modules/mod_bt_sociallogin/tmpl/images/fb.png"/></a></li><?php endif;*/?>
					<?php if($enable_fb):?><li id="bt-facebook"><a href="JavaScript:newPopup('<?php echo $dialog_urlFB?>','<?php echo JText::sprintf ( 'MOD_BT_LOGIN_CONNECT_TITLE', 'Facebook'); ?>',600,400);"><img src="<?php echo T3_TEMPLATE_URL; ?>/html/mod_bt_sociallogin/images/fb.png"/></a></li><?php endif;?>
					<?php /*if($enable_gg):?><li id="bt-google"><a href="JavaScript:newPopup('<?php echo $dialog_urlGG?>','<?php echo JText::sprintf ( 'MOD_BT_LOGIN_CONNECT_TITLE', 'Google'); ?>',600,400);"><img src="<?php echo JURI::root(); ?>/modules/mod_bt_sociallogin/tmpl/images/gg.png" /></a></li><?php endif;*/?>
					<?php if($enable_gg):?><li id="bt-google"><a href="JavaScript:newPopup('<?php echo $dialog_urlGG?>','<?php echo JText::sprintf ( 'MOD_BT_LOGIN_CONNECT_TITLE', 'Google'); ?>',600,400);"><img src="<?php echo T3_TEMPLATE_URL; ?>/html/mod_bt_sociallogin/images/gg.png" /></a></li><?php endif;?>
					<?php /*if($enable_twitter):?><li id="bt-twitter"><a href="JavaScript:newPopup('<?php echo $dialog_urlTT?>','<?php echo JText::sprintf ( 'MOD_BT_LOGIN_CONNECT_TITLE', 'Twitter'); ?>',600,400);"><img src="<?php echo JURI::root(); ?>/modules/mod_bt_sociallogin/tmpl/images/tt.png"/></a></li><?php endif;*/?>
					<?php if($enable_twitter):?><li id="bt-twitter"><a href="JavaScript:newPopup('<?php echo $dialog_urlTT?>','<?php echo JText::sprintf ( 'MOD_BT_LOGIN_CONNECT_TITLE', 'Twitter'); ?>',600,400);"><img src="<?php echo T3_TEMPLATE_URL; ?>/html/mod_bt_sociallogin/images/tt.png"/></a></li><?php endif;?>
					<li style="clear:both; height: 0; padding: 0; margin: 0;"></li>
				</ul>
			</div>
			<?php endif;?>
		...
		<div id="btl-content-registration"  class="btl-content-block">			
			...
			<form id="btl-form-register" name="btl-formregistration" class="btl-formregistration form-validate" onsubmit="return registerAjax();"  autocomplete="off">
					...
					<div class="bt-scroll">
						...
						<!-- show captcha -->
						<?php if ($captchaField && $enabledCaptcha): ?>
							<div class="btl-field">
								<div class="btl-label">
									<?php echo $captchaField->label ;?>
								</div>
								<div class="btl-input" style='height:150px;'><?php echo $captchaField->input;?></div>
							</div>
						<?php endif;?>
						<div class="btl-buttonsubmit">						
